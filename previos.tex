...
%\begin{enumerate}
%	\item Ecuación \ref{eq:carga_transmision_opacos}: Carga térmica por transmisión a través de cerramientos opacos \dotfill \pageref{eq:carga_transmision_opacos}
%	\item Ecuación \ref{eq:carga_transmision_traslucidos}: Carga térmica por transmisión a través de cerramientos traslúcidos \dotfill \pageref{eq:carga_transmision_traslucidos}
%	\item Ecuación \ref{eq:carga_radiacion_solar}: Carga térmica por radiación solar \dotfill \pageref{eq:carga_radiacion_solar}
%	\item Ecuación \ref{eq:carga_ventilacion_infiltracion}: Carga térmica por ventilación o infiltración \dotfill \pageref{eq:carga_ventilacion_infiltracion}
%\end{enumerate}
