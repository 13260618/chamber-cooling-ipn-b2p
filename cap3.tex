  \newpage
 %\chapter*{Capítulo I}
 \addcontentsline{toc}{chapter}{CAPÍTULO I. Antecedentes del proyecto}
 %\textit{Trabajo previo ...}
 %\chapter*{Capítulo II}
 \addcontentsline{toc}{chapter}{CAPÍTULO II. Contexto del proyecto}
 %\textit{Trabajo previo ...}
...
\begin{enumerate}
	\item Cuando un artículo se introduce en una cámara de refrigeración o congelación, su temperatura disminuye hasta alcanzar la temperatura deseada, (vea el \hyperref[anexo:bohn-perecederos]{anexo 1})  , para conocer algunas características comunes a considerar en el diseño. Este proceso involucra tres componentes de carga térmica:
	\begin{enumerate}
...
\begin{figure}[H]
	...
	\label{fig:design-enfria}  Fuente: Elaboración propia basado de \citeNP{bibliocad}
\end{figure}
...
\end{figure} 
Consulte los anexos \hyperref[axo-design-div]{2 a 4} para ver más detalles de los planos y del diseño.
